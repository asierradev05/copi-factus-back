...
const EMAIL = 'testsprite.demo@copigrafica.dev';
const FULL_NAME = 'TestSprite Demo';
const ROLE = 'ADMIN' as const;
// Contraseña demo dedicada para los tests automatizados de TestSprite.
const PASSWORD = 'TsDemo@2026!Secure';
